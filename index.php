...
if($statusnumrows > 0){
	...
	$statuslist1 = '<h2 class="font-lightgray center-text">Hmmm... Looks Like Something Is Wrong.</h2><p class="font-gray bold center-text">Please <a href="contact.php">Contact</a> Us and Let Us Know! Thanks.</p><div class="dummy-space">
	</div>';
}
?><?php
$statuslist = "";
...
if($statusnumrows68 > 0){
	...
	$statuslist = '<h2 class="font-lightgray center-text">Hmmm... Looks Like Something Is Wrong.</h2><p class="font-gray bold center-text">Please <a href="contact.php">Contact</a> Us and Let Us Know! Thanks.</p><div class="dummy-space">
	</div>';
}
?>
<!DOCTYPE html>
...
fbq('init', '1846430102300643'); // Insert your pixel ID here.
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1846430102300643&ev=PageView&noscript=1"
/></noscript>
<!-- DO NOT MODIFY -->
...
<!-- End Facebook Pixel Code -->
  ...
  <title>SelfBased | Learn Something New</title>
  <meta name="description" content="Get the best sources on the net to learn new things. SelfBased organizes top sources for your topic and gives you the best options.">
...
<div class="ism-slider fixed" style="border-radius: 0; top: -1%;; z-index: 9;" data-play_type="loop">
    ...
    <li>
			<div style="background-image: url(ism/image/slides/_u/1443055834370_925381.jpg)" class="image full">
				<h1 class="absolute large-font text-shadow left-text-align" style="margin-left: 10%; margin-top: 20%;">Learn Anything You've Ever Wanted.</h1>
			</div>

		</li>
    <li>
			<div style="background-image: url(ism/image/slides/_u/1443056005351_94525.jpg)" class="image full">
				<h1 class="absolute large-font font-white text-shadow left-text-align" style="margin-left: 10%; margin-top: 20%;">Get The Best Sources Rated By Real People.</h1>
			</div>

		</li>
    <li>
			<div style="background-image: url(ism/image/slides/_u/1443056039341_126365.jpg)" class="image full image-bottom">
				<h1 class="absolute large-font font-white third-width text-shadow left-text-align" style="margin-left: 10%; margin-top: 20%;">Find Your Hidden Talents.</h1>
			</div>
...
<main>
	<div class="header-img-parallax">
	  ...
	  <div class="pageMiddle">
			<h1 class="center-text">What Do You Want To Learn?</h1>
	    ...
	    <div class="container-2 transparent med-margin-top">
	      ...
	      <div class="flex-box">
					<div class="center-text">
						<p class="big-font">With SelfBased you can search for the best sources in the world to learn your favourite skills. You can learn anything from programming, to marketing, to skiing and to anything that you might find interesting. <strong>Start Learning Today!</strong></p> <br>
						<div class="center-text">

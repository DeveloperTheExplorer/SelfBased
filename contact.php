...
Please Do Not Respond To This Email!';
      ...
      $to = "contact@selfbased.com";
      $from = "auto_responder@selfbased.com";
      $subject = "$subject";
      $message = 'Message sent by '.$name.' with the email '.$email.'.
...
<head>
  ...
  <meta name="description" content="Let us know anything that you have in mind! Your feedback is very important to us.">
    ...
    <div class="parallax">
      ...
      <div style="padding-left: 15px;" class="small-margin-top">
        ...
        <div class="med-full-container ">
          ...
          <p>Advertise with us: <a href="mailto:advertisement@selfbased.com">advertisement@selfbased.com</a></p>

          <p>Business inquiries: <a href="mailto:business@selfbased.com">business@selfbased.com</a></p>

          <p>Feedback for our site: <a href="mailto:feedback@selfbased.com">feedback@selfbased.com</a></p>

          <p>General inquiries: <a href="mailto:contact@selfbased.com">contact@selfbased.com</a></p>

          <p>Legal inquiries: <a href="mailto:legal@selfbased.com">legal@selfbased.com</a></p>
        </div>
      </div>

...
if(isset($_POST["e"])){
	...
	if($numrows > 0){
		...
		$msg = '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>SelfBased</title><style>a{text-decoration: none;color: #3EA7FD;}a:hover{color: #0073c0;text-decoration: underline;}h2{display: inline-block;margin-left: 20px;margin-top: 10px;color: #fff;}body{background-color: #fff;}</style></head><body style="margin:0px; background-color: #fff; font-family:Tahoma, Geneva, sans-serif;"><div style="padding:10px; background:#fff; font-size:24px; color:#CCC; height:60px;"><a href="http://www.SelfBased.com"><img src="http://www.SelfBased.com/style/nosettles.svg" width="60" height="50" alt="SelfBased" style="border:none; float:left;"></a><h2>Hello '.$u.'</h2></div><p>This is an automated message from SelfBased. If you did NOT recently initiate the Forgot Password process, please disregard this email.</p><p>You indicated that you forgot your login password. We can generate a temporary password for you to log in with, then once logged in you can change your password to anything you like.</p><p>After you click the link below your password to login will be:<br /><b>'.$tempPass.'</b></p><p><a href="http://www.SelfBased.com/forgot_pass.php?u='.$u.'&p='.$hashTempPass.'">Click here now to apply the temporary password shown above to your account</a></p><p>If you do not click the link in this email, no changes will be made to your account. In order to set your login password to the temporary password you must click the link above.</p></body></html>';
...
<head>
<meta charset="UTF-8">
<title>SelfBased | Forgot Password</title>

...
if ($log_username != "") {
	$addmore = '<div class="med-large-font font-lightgray center-text full-width">Do you know a source related to "'.$search.'"?<br/> <a href="new_post.php">Click Here</a> to add it to our system!</div>';
} else {
	$addmore = '<div class="med-large-font font-lightgray center-text full-width">Do you know a source related to "'.$search.'"?<br/> <span class="login-launch link">Login</span> or <span class="signup-launch link">Sign up</span> and add it to our system!</div>';
}
